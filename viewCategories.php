...
$items = $ItemRepository->get('categories');

echo '<table>';
echo '<tr><th>ID</th><th>Name</th><th>Images</th><th>Action</th><th>Action</th></tr>';
foreach ($items as $item) {
    echo '<tr>';
    echo '<td>' . $item['id'] . '</td>';
    echo '<td>' . $item['name'] . '</td>';
    echo '<td>
    <img src="uploads2/' . $item['image'] . '" alt="Item Image" style="width:100px;height:auto;">
